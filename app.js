...
app.use(session({
    secret: "our little sercret kh khhh.",
    resave: false,
...
app.post("/register", function (req, res) {
    ...
    User.register({ username: req.body.username }, req.body.password, function (err, user) {
        if (err) { console.log(err); res.redirect("/login"); } else {
...
//                     if (hashResult === true) { res.render("secrets"); console.log(result); } else { console.log("Password did not match  " + hashResult); }
//                 })
